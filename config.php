<?php
	...
	$config['name'] = 'Formula 1® Weekly Standings'; 						// The Title of the publication
	$config['description'] = 'The latest standings in the Formula 1® World Championship.'; 		// The description of the publication
